...
while (true) {
    ...
    // Opção 'a': Imprimir dados de um filme
    if (opcao === 'a') {
    ...
    // Opção 'b': Avaliar um filme (média da nova e antiga nota)
    else if (opcao === 'b') {
    ...
    // Opção 'c': Alterar dados de um filme
    else if (opcao === 'c') {
    ...
    // Opção 'd': Finalizar execução e imprimir todos os dados
    else if (opcao === 'd') {
